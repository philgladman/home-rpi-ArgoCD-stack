...
EOF
```
- update perms of our script `sudo chmod 700 ~/DYNU/updateIP.sh`
- Now that we have our script configured, lets create a cronjob that runs the script every 5 minutes `echo "*/5 * * * * /home/ubuntu/DYNU/updateIP.sh" | crontab -`.
